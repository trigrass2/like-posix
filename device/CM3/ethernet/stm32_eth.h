...
#define MAX_ETH_PAYLOAD        		ETH_BUFFER_SIZE//1500    /*!< Maximum Ethernet payload size */
#define JUMBO_FRAME_PAYLOAD    		9000    /*!< Jumbo frame payload size */
#define ETH_MAX_PACKET_SIZE    		(ETH_BUFFER_SIZE+ETH_HEADER+ETH_EXTRA+ETH_CRC)//1520    /*!< ETH_HEADER + ETH_EXTRA + MAX_ETH_PAYLOAD + ETH_CRC */
